...
<!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="content-heading mb-0 text-gray-800">My Profile</h1>
    </div>
    <div class="row">
        <div class="col-3">
            <ul class="navbar-nav bg-white sidebar accordion border-right pt-4 no-toggled" id="accordionSidebar">
                <li class="nav-item">
                    <a class="nav-link active"  href="/user/profile/<?= $user['id']; ?>">
                        <div class="nav-icon">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/user/profile/vendor/<?= $user['id']; ?>">
                        <div class="nav-icon">
